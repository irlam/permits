...
# The checked-in root PWA icons are generated from /favicon.svg and are the
# canonical raster versions of the hard-hat/check brand mark. This helper keeps
# the service-worker copies in sync and creates the small 32px raster without
# ever recreating the old blue square / white "P" artwork.
