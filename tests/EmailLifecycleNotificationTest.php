...
{
    public function testApprovalAndRejectionNotificationsQueueWithPublicPermitLink(): void
    {
        ...
        try {
            ...
            $form = [
                ...
                'valid_from' => '2026-07-22 09:00:00',
                'valid_to' => '2026-07-22 17:00:00',
            ];
            ...
            self::assertStringContainsString(
                'view-permit-public.php?link=' . str_repeat('a', 64),
                $rows[0]['body']
            );
